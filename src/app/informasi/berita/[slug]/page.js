                        ...
                        <section style={{ width: "90vw", maxWidth: "1260px" }}>
                            <Grid container
                                ...
                                <Grid item xs={12} sm={12} md={9} lg={9} xl={9}>
                                    <CardMedia component='div' sx={{ mb: -1, position: "relative", width: "100%", aspectRatio: "16/9" }}>
                                        <img
                                            style={{
                                                width: "100%",
                                                height: "100%",
                                            ...
                                            {newsList.map((news) => (
                                                <Grid item key={news.slug} xs={6} sm={6} md={2} lg={2} xl={2}>
                                                    <Card elevation={0} square={true} sx={{ background: "none" }}>
                                                        <Link id="btnDetailBeritaOtherNews" href={`/informasi/berita/${news.slug}`}>
                                                            <CardMedia component='div' sx={{ mb: -1, position: "relative", width: "100%", aspectRatio: "16/9" }}>
                                                                {news.source_image && (
                                                                    <img
                                                                        style={{
