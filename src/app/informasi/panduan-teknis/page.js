...
import { Box, Button, Card, Tab, Tabs, Typography, useMediaQuery, useTheme, Select, MenuItem, CircularProgress, Divider, Stack } from "@mui/material";
        ...
        <>
            <main className={styles.main}>
                ...
                >
                    ...
                    <div className={styles.container} style={{ paddingTop: "20px", width: "100%", textAlign: "center" }}>
                        <section id="aplikasi"
                            style={{
                                marginTop: "50px",
                                maxWidth: "1200px",
                            ...
                            <div style={{ marginTop: "44px" }}>
                                <Stack direction="column" justifyContent="center" alignItems="center" gap={6}>
                                    <Typography variant='p' sx={{
                                        ...
                                        Petunjuk pelaksanaan pemutakhiran dan pengintegrasikan sistem peta dan data dalam sistem informasi geospasial Jakarta Satu ini disusun dalam rangka memfasilitasi integrasi spasial dari semua perangkat daerah di lingkungan Pemerintah Provinsi DKI Jakarta ataupun instansi lainnya agar dapat mewujudkan integrasi informasi gespasial di wilayah DKI Jakarta dalam wadah Jakarta Satu untuk meningkatkan kinerja penataan dan pembangunan kota.
                                    </Typography>
                                    <Stack direction={{ xs: "column", sm: "row" }} justifyContent="center" alignItems="center" gap={2}>
                                        <Link href="https://drive.google.com/file/d/1AU04yFobQdspwEL7Ordx62cxxr173GLj/preview" target='_blank'>
                                        ...
                                        <Link href="https://drive.google.com/file/d/1mlzkmFjZj6we0L8hX2HOxc1-f-EglcmX/preview" target='_blank'>
                                            <Button variant='contained' sx={{
                                                width: "100%",
                                                maxWidth: "388px",
                                                height: "49px",
