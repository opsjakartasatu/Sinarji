                    ...
                    <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Stack direction="column" justifyContent="center" alignItems="flex-start" gap={4}>
                            ...
                            <Typography variant="p"
                                ...
                                Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Silahkan periksa informasi login Anda atau kembali ke halaman dashboard.
                            </Typography>
                            <Link href="/internal-test/dashboard"
                                style={{
                                    width: "309px",
                                    height: "57px",
                                    fontWeight: "600",
