...
const KKOP = ({ 
  ...
  const clickHandlerRef = useRef(null); // Add ref for click handler
  ...
  const handleViewClick = useCallback((event) => {
    ...
    view.hitTest(event).then((response) => {
      ...
      // If click is on KKOP layer, prevent popup by stopping propagation
      if (kKOPHit) {
        event.stopPropagation();
        // Optionally close any existing popup
        if (view.popup) {
          view.popup.close();
        }
      }
 ...
 return (
    <>
      {/* Widget Button - Enhanced with gradient and better shadow */}
      ...
      {/* Widget Panel - Enhanced with modern design */}
      {widgetOpen && (
        <Paper
          sx={{
            ...getWidgetPosition(),
        ...
        >
          {/* Header - Enhanced gradient and better typography */}
          <Box
            sx={{
              display: "flex",
              justifyContent: "center",
