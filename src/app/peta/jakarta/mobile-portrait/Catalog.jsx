...
const Catalog = ({
  ...
  const [isMinimizedKategori, setIsMinimizedKategori] = useState(true);
  const [isMinimizedSimpul, setIsMinimizedSimpul] = useState(true);
  ...
  const Search = styled("div")(({ theme }) => ({
    ...
    width: "100%", // Changed from "62px" to "100%"
    maxWidth: "220px", // Added max width to limit search box size
    height: "30px",
    marginLeft: "0px",
    marginRight: "12px",
  }));
  ...
  return (
    ...
    >
      ...
      >
        <Typography
          variant="h6"
          sx={{ fontSize: "18px", justifyContent: "center", fontWeight: "500" }}
        >
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  borderRadius: isMinimizedKategori ? "8px" : "8px 8px 0px 0px",
                  background: "#003577",
              ...
              >
                ...
                <IconButton
                  onClick={() => setIsMinimizedKategori(!isMinimizedKategori)}
                  sx={{ color: "white" }}
                >
                  {isMinimizedKategori ? (
                    <ExpandMoreIcon />
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  alignItems: "center",
                  justifyContent: "space-between",
                  borderRadius: isMinimizedSimpul ? "8px" : "8px 8px 0px 0px",
                  background: "#003577",
                  padding: "10px 12px 10px 28px",
                  height: "40px",
                }}
              >
                ...
                <IconButton
                  ...
                  sx={{ color: "white" }}
                >
                  {isMinimizedSimpul ? <ExpandMoreIcon /> : <ExpandLessIcon />}
                </IconButton>
              </Box>
            ...
            >
              ...
              >
                ...
                {/* <Box sx={{ flexGrow: 1 }}>
                  <Toolbar
                    sx={{
                      padding: "8px 0", // Reduced horizontal padding
                      display: "flex",
                  ...
                  >
                    <Search
                      sx={{
                        ...
                        maxWidth: "260px", // Controls the maximum width
                        alignItems: "center",
                      }}
                    >
                      <SearchIconWrapper>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <SearchIconWrapper
                        sx={{
                          height: "30px", // Match the height of your Search component
                          display: "flex",
                          alignItems: "center",
                        }}
                      >
                      ...
                      >
                        ...
                        >
                          <FormControlLabel
                            ...
                            sx={{ marginRight: "12px", paddingLeft: "0px" }}
                          />
                          <Typography
                            sx={{
                              fontSize: "14px",
