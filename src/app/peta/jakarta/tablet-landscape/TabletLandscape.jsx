...
const TabletLandscape = () => {
      ...
      >
        ...
        >
          <Home
            ...
            tooltip={"top"}
          />
          <FullScreen buttonSize={"40px"} tooltip={"top"} />
          <UploadData
            view={view} 
          ...
          <MeasurementLine
            ...
            tooltip={"top"}
          />
          <Locate view={view} buttonSize={"40px"} tooltip={"top"} />
          <Bahasa buttonSize={"40px"} tooltip={"top"} bahasa={bahasa} setBahasa={setBahasa} />
        </Box>
        <Box
          sx={{
            display: "flex",
        ...
        >
          <Search view={view} width={"280px"} height={"40px"} bahasa={bahasa} />
        </Box>
      </Box>
      {/* BOT RIGHT */}
      <Box
 ...
 <Box
      ...
      <Box>
        ...
        <Box sx={{position: "absolute", display: "flex", right: "10%", bottom:  tableOpen ? "35%" : "10%",}}>
