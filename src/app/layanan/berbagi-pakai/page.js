                        ...
                        <section id="berbagiPakai"
                            ...
                            <Grid container
                                ...
                                <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                                    <CustomImage
                                        src="/assets/layanan-berbagi-pakai.png"
                                        alt="Gambar"
                                        priority={true}
                                        draggable={false}
                                        width={0}
                                ...
                                <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                                    <Stack
                                        ...
                                        <Typography variant="p"
                                            ...
                                            Dapatkan kemudahan untuk layanan pemanfaatan, permohonan dan pengintegrasian data di Jakarta Satu. Kamu juga bisa unduh data di sini!
                                        </Typography>
