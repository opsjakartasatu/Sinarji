    ...
    useEffect(() => {
        const getAplikasiList = async () => {
            const response = await axios.get(
                process.env.API_WEB + "/aplikasi"
                // "../api/aplikasi"
            );
            // const newsLatest = response.data.data.data;
            const newsLatest = response.data.data.data;

            setAplikasiList(newsLatest);
        };
                        ...
                        <section id="aplikasi"
                            ...
                            <div style={{ margin: "50px 0", }}>
                                <Typography variant='p' sx={{
                                    ...
                                    Dapatkan informasi terkait hasil dari aplikasi yang berkolaborasi dengan berbagai instansi ataupun Dinas Pemerintahan yang ada di DKI Jakarta
                                </Typography>
                            </div>
                            <Box
                                sx={{
                                    ...
                                    "& :first-of-type": {
                                        gridColumn: { xs: "", sm: "", md: "span 2" },
                                        display: "flex",
                                        alignItems: "center",
                                        justifyContent: "center"
                                    }
                                }}>
                                {aplikasiList.sort(() => Math.random() - 0.5).map((aplikasi, i) => (
                                    <Box key={i} sx={{
                                        display: "flex",
                                        ...
                                        <Grid
                                            container
                                            direction={
                                                i === 0 ? isMobileMD ? "row" : "row-reverse"
                                                    :
                                                    i % 2 === 0 ? { sm: "row", md: "row-reverse" } : { sm: "row-reverse", md: "row" }
                                            }
                                            justifyContent="center"
                                            alignItems="center"
                                            spacing={2}
                                            sx={{ flexGrow: 1 }}>
                                            {isMobile600 ? null : (
                                                <Grid xs={12} sm={8} md={i === 0 ? 6 : 8} lg={i === 0 ? 6 : 8} xl={i === 0 ? 6 : 8}>
                                            ...
                                            <Grid xs={12} sm={4} md={i === 0 ? 6 : 4} lg={i === 0 ? 6 : 4} xl={i === 0 ? 6 : 4}>
                                                <Stack
                                                    direction="column"
                                                    justifyContent="center"
                                                    alignItems="center"
                                                    ...
                                                    {i === 0 ? (
                                                        <Link href={aplikasi.link} target="_blank">
                            ...
                            {/* <Box
                                ...
                                {menu.map((aplikasi, i) => (
                                    <Box key={i} sx={{
                                        ...
                                        <Grid
                                            container
                                            // direction={i === 0 ? isMobileMD ? "row" : "row-reverse" : i % 2 === 0 ? "row-reverse" : "row"}
