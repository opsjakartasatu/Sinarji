...
function urunData() {
    ...
    const menu = [
        {
            id: 1,
            text: 'Surveilans',
            imgSrc: '/assets/aplikasi-surveilans.png',
            desc: 'Menampilkan data kondisi kesehatan, angka kematian, serta rumah sakit hasil kolaborasi dengan Dinas Kesehatan DKI Jakarta.',
            externalLink: 'https://surveilans-dinkes.jakarta.go.id/'
        },
        {
            id: 2,
            text: 'DBDKlim',
            imgSrc: '/assets/aplikasi-dbdklim.png',
            desc: 'Peta prediksi angka insiden DBD dan prediksi kelembaban udara dalam upaya mencegah penyebaran penyakit DBD.',
            externalLink: 'https://iklim.bmkg.go.id/id/dbdklim/'
        },
    ];
    ...
    const [urunDataList, setUrunDataList] = useState([]);

    useEffect(() => {
        document.title = "Kolaborasi | Jakarta Satu (Satu Peta, Satu Data, Satu Kebijakan)";

        const getUrunDataList = async () => {
            const response = await axios.get(
                process.env.API_WEB + "/urun-data/list"
            );
            const newsLatest = response.data.data;
            setUrunDataList(newsLatest);
        };
                ...
                >
                    ...
                    <div className={styles.container} style={{ paddingTop: "20px", textAlign: "center" }}>
                        <section id="urunData"
                            ...
                            />
                            <Stack direction="column" justifyContent="center" alignItems="center" gap={8} sx={{ marginTop: "50px" }}>
                                <Typography variant='p' sx={{
                                    ...
                                    Ingin turut serta meningkatkan kualitas data dan informasi di Jakarta Satu? <br />
                                    Kanal urun data menjadi ruang kontribusi untukmu!  <br />
                                ...
                                <Box>
                                    <Grid
                                        ...
                                        alignItems="center"
                                        spacing={5}>
                                        {urunDataList.map((urunData, i) => (
                                            <Grid key={i} xs={12} sm={12} md={12 / 2} lg={12 / 2} xl={12 / 2}>
                                                <Stack direction="row" justifyContent="center" alignItems="center" gap={{ xs: 2, sm: 4, md: 4, lg: 4, xl: 4 }} sx={{
                                                    borderRadius: "20px",
                                                    // width: "100%",
                                                    maxWidth: "497px",
                                                    height: "258px",
                                                    ...
                                                    <Stack direction="column" justifyContent="center" alignItems="center" gap={2}>
                                                        ...
                                                        <Link href={urunData.link} target='_blank'>
                                                    ...
                                                    <Box sx={{ width: "100%", maxWidth: "200px", height: "auto" }}>
                                                        <img
                                                            src={urunData.icon}
                                                            alt="Gambar"
                                                            draggable={false}
