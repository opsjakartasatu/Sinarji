...
import { Box, Button, Card, CardActionArea, CardContent, CardMedia, CircularProgress, Divider, Grid, OutlinedInput, Stack, Typography, useMediaQuery, useTheme } from "@mui/material";
...
function simpulJaringan() {
        ...
        const getSimpulJaringanList = async () => {
            try {
                const response = await axios.get(
                    process.env.API_WEB + "/simpul-jaringan/?limit=1000"
                );
                const allList = response.data.items;

                // Filter dan urutkan data berdasarkan jumlah_nama_data
                const sortedAndFilteredList = allList
                    .filter((item) => item.icon !== null) // Filter icon yang tidak null
                    .sort((a, b) => b.jumlah_nama_data - a.jumlah_nama_data); // Urutkan berdasarkan jumlah_nama_data secara descending

                const slicedData = sortedAndFilteredList.slice(0, 5); // Ambil 5 data teratas
                setSimpulJaringanTop5(slicedData);

                setSimpulJaringanList(allList); // Tetap menyimpan semua data asli
    ...
    const filteredSimpulJaringanList = simpulJaringanList
        .filter((simpulJaringan) => simpulJaringan.icon !== null)
    ...
    useEffect(() => {
        setVisibleDataCount(isMobile ? 10 : 20);
    }, [isMobile]);
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className={styles.container} style={{ paddingTop: "20px", textAlign: "center" }}>
                                <section id="allSpkd" style={{ width: "90vw", maxWidth: "1350px", marginTop: "50px" }}>
                                    <Stack
                                        direction="column"
                                        justifyContent="space-between"
                                        alignItems="center"
                                        spacing={isMobile ? 3 : 6}
                                        sx={{ width: "90vw", maxWidth: "100%", marginBottom: isMobile ? "20px" : "80px" }}>
                                        <div>
                                            ...
                                            <Divider
                                                style={{
                                                    ...
                                                    width: '75px',
                                                    borderRadius: '4px',
                                                    margin: isMobile ? "15px auto" : "18px auto 0 auto"
                                                }}
                                            />
                                        </div>
                                        <OutlinedInput
                                    ...
                                    <Grid container
                                        ...
                                        {filteredSimpulJaringanList.map((simpulJaringan, i) => (
                                            <Grid key={i} item xs={6} sm={3} md={12 / 5} lg={12 / 5} xl={12 / 5}>
                                                <Card key={i} elevation={0} sx={{ background: "none", height: "100%" }}>
                                                    <CardActionArea id="btnsimpulJaringanDetailSimpulJaringan" href={`${basePath}/kolaborasi/simpul-jaringan/${simpulJaringan.id}`} disableRipple
                                                        sx={{
                                    ...
                                    <Button id="btnsimpulJaringanLihatLebihBanyakSimpulJaringan" variant="contained" onClick={handleLoadMoreClick}
                                        sx={{
                                            mt: 4,
                                            borderRadius: "40px",
                                ...
                                <section id="kolaborasiTop5skpd" style={{ paddingTop: "100px", paddingBottom: isMobile ? "75px" : "50px", margin: "auto", width: isMobile ? "90vw" : "", maxWidth: "1350px" }}>
                                    ...
                                    />
                                    <div style={{ width: "100%", maxWidth: "1146px", margin: "50px auto", }}>
                                        <Typography variant='p' sx={{
                                            ...
                                            Lima simpul jaringan SKPD terbaik berdasarkan jumlah data spasial yang terkolaborasi di portal Jakarta Satu
                                        </Typography>
                                    </div>
                                    <Box
                                        sx={{
                                            alignItems: "center",
                                            maxWidth: isMobile ? "99vw" : "1100px",
                                            // columnGap: "25px",
                                            mt: 6,
                                            display: 'grid',
                                            gridTemplateColumns: {
                                        ...
                                        {simpulJaringanTop5.map((simpulJaringan, i) => (
                                            <Card key={i} elevation={0}
                                                ...
                                                <CardActionArea id="btnkolaborasi5SimpulJaringan"  href={`${basePath}/kolaborasi/simpul-jaringan/${simpulJaringan.id}`} disableRipple
                                                    sx={{
                                                        padding: "10px",
                                                        borderRadius: "25px",
                                                        height: "100%",
                                                        ...
                                                        {i === 0 ? (
                                                            <img
                                                                ...
                                                                style={{
                                                                    ...
                                                                    maxWidth: isMobile900 ? "250px" : "100%",
                                                                    maxHeight: isMobile900 ? "100%" : "299px",
                                                                    alignSelf: 'center'
                                                                }}
                                                            />
                                                        ) : (
                                                            <img
                                                                ...
                                                                style={{
                                                                    // width: "auto",
                                                                    // maxHeight: "100%",
                                                                    // maxWidth: isMobile ? "250px" : '124px',
                                                                    maxWidth: isMobile900 ? "250px" : "100%",
                                                                    maxHeight: isMobile900 ? "100%" : '122px',
                                                                    alignSelf: 'center'
                                                                }}
                                                            />
                                                        )}
