  ...
  return (
    <>
      <div className="navbarFotoUdara" style={{ width: isMobile ? "90vw" : "97vw" }}>
        ...
        >
          Histori Foto Udara DKI
        </Typography>
        {isMobile ? (
          <DrawerFotoUdara isPlaying={isPlaying} togglePlay={togglePlay} isSwipeMode={isSwipeMode} toggleSwipeMode={toggleSwipeMode} isCompareMode={isCompareMode} toggleCompareMode={toggleCompareMode} />
        ) : (
          <>
            <Stack
              direction="row"
